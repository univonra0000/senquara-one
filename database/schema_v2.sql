...
CREATE TABLE IF NOT EXISTS users(id TEXT PRIMARY KEY,email TEXT NOT NULL UNIQUE,name TEXT NOT NULL,mobile TEXT,business_name TEXT,country TEXT,password_hash TEXT NOT NULL,password_salt TEXT NOT NULL,role TEXT NOT NULL DEFAULT 'staff',status TEXT NOT NULL DEFAULT 'active',email_verified INTEGER NOT NULL DEFAULT 0,terms_version TEXT DEFAULT '',terms_accepted_at TEXT,created_at TEXT NOT NULL,updated_at TEXT,must_change_password INTEGER NOT NULL DEFAULT 0,google_sub TEXT,google_email TEXT);
